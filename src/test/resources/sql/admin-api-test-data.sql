...
VALUES
    ('e1111111-1111-1111-1111-111111111111', 'f1111111-1111-1111-1111-111111111111', CURRENT_DATE - INTERVAL '2 days', 10000, 10100, 9900, 10050, 1000000, NOW(), NOW()),
    ('e2222222-2222-2222-2222-222222222222', 'f1111111-1111-1111-1111-111111111111', CURRENT_DATE - INTERVAL '1 day', 10050, 10200, 10000, 10150, 1200000, NOW(), NOW()),
    ('e3333333-3333-3333-3333-333333333333', 'f2222222-2222-2222-2222-222222222222', CURRENT_DATE - INTERVAL '2 days', 200, 205, 198, 204, 2000000, NOW(), NOW()),
    ('e4444444-4444-4444-4444-444444444444', 'f2222222-2222-2222-2222-222222222222', CURRENT_DATE - INTERVAL '1 day', 204, 207, 203, 206, 1800000, NOW(), NOW());
...
VALUES
    ('fb111111-1111-1111-1111-111111111111', 'a7490f7e-8596-41ff-abb0-ff06894928f2', NULL, CURRENT_DATE - INTERVAL '3 days', 1.5000, 1.3000, 0.2000, 10150000.00, NOW() - INTERVAL '3 days'),
    ('fb222222-2222-2222-2222-222222222222', 'a7490f7e-8596-41ff-abb0-ff06894928f2', NULL, CURRENT_DATE - INTERVAL '2 days', 2.5000, 2.1000, 0.4000, 10250000.00, NOW() - INTERVAL '2 days'),
    ('fb333333-3333-3333-3333-333333333333', 'a7490f7e-8596-41ff-abb0-ff06894928f2', NULL, CURRENT_DATE - INTERVAL '1 day', 4.0000, 3.2000, 0.8000, 10400000.00, NOW() - INTERVAL '1 day');
